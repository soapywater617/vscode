...
if page == "Landing Page":
    ...
    # Logo
    logo_path = "landing_image.png"
    if os.path.exists(logo_path):
        with col2:
            st.image(logo_path, use_container_width=False, width=220)
    else:
        st.image("https://github.com/soapywater617/vscode/blob/b081cdd8a3218cbae5ac2838ca07b1a220201e05/landing_image.png", use_container_width=False, width=220)
    st.write("")
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        st.image("tira.png", use_container_width=True) #tira
    ...
    with col2:
        st.image("matcha_puff.png", use_container_width=True) #matchapuff
    ...
    with col3:
        st.image("pink_cupcake.png", use_container_width=True) #strawcupcakes
    ...
    with col2:
        ...
        st.image("customcake_ia.png", width=200) #custom cake pic
    ...
    with col5:
        if (os.path.exists("gglogo.png")):
            st.image("gglogo.png", use_container_width=True)
    ...
    with col2:
        st.image("plainbagels.png", use_container_width=True) #plainbagels
    col3, col4 = st.columns([2, 3])
    with col3:
        st.image("straw_cake.png", use_container_width=True) 
    with col4:
    ...
    with col5:
        st.image("bearbuns.png", use_container_width=True)
    ...
    with col6:
        ...
        st.image("bearbagels2.png", use_container_width=True) #bearbagels!
...
#     render_footer()
    ...
    st.image("map.png", use_container_width=True) #map T-T
    ...
    with col1:
        st.image("cafe_sitting.png", use_container_width=True) #cafe_sitting.png
    with col2:
        st.image("gglogo.png", use_container_width=True) #gglogo? or other pic
    ...
    with col1:
        ...
        st.image("bearbagels2.png", use_container_width=True) #bearbagels2?
    with col2:
    ...
    past_event_imgs = [
        "customcookieorder.jpg",
        "puffpuff.png",
        "hcbopen.png",
        "matcha_puff.png",
        "tirastack.png",
        "hcb_ricekrispies.png"
    ]
    texts = [
    ...
    with col4:
        st.image("gracepic.png", width=220)    
    with col3:
